...
abstract class ITradeRequestRepo {
  Future<Either<Failure, IList<TradeRequestModel>>> findAll();
  ...
  Future<Either<Failure, TradeRequestModel>> update(TradeRequestId tradeRequestId ,{required TradeRequestUpdateParam data});

  Future<Either<Failure, Unit>> delete(TradeRequestId id);

  Future<Either<Failure, IList<TradeRequestModel>>> findPagination({
    required int limit,
    required int offset,
...
class _Impl implements ITradeRequestRepo {
  ...
  @override
  Future<Either<Failure,  TradeRequestModel>> update(TradeRequestId tradeRequestId ,{required TradeRequestUpdateParam data}) async{
    return await errorHandler(() async {
    return await _ref.supabaseClient
    .from(TradeRequestModel.table.tableName)
    .update(data.toJson())

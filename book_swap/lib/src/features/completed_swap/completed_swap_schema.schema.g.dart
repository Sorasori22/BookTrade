...
_$CompletedSwapLiteModelImpl _$$CompletedSwapLiteModelImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CompletedSwapLiteModelImplToJson(
        _$CompletedSwapLiteModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id.toJson(),
      'requester_id': instance.requesterId.toJson(),
      'owner_id': instance.ownerId.toJson(),
...
_$CompletedSwapDetailModelImpl _$$CompletedSwapDetailModelImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CompletedSwapDetailModelImplToJson(
        _$CompletedSwapDetailModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id.toJson(),
      'requester_id': instance.requesterId.toJson(),
      'owner_id': instance.ownerId.toJson(),
...
_$CompletedSwapCreateParamImpl _$$CompletedSwapCreateParamImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CompletedSwapCreateParamImplToJson(
        _$CompletedSwapCreateParamImpl instance) =>
    <String, dynamic>{
      'requester_id': instance.requesterId.toJson(),
      'owner_id': instance.ownerId.toJson(),
      'requester_book_id': instance.requesterBookId.toJson(),
...
_$CompletedSwapUpdateParamImpl _$$CompletedSwapUpdateParamImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CompletedSwapUpdateParamImplToJson(
        _$CompletedSwapUpdateParamImpl instance) =>
    <String, dynamic>{
      'completed_at': instance.completedAt?.toIso8601String(),
    };
...
const _tableCompletedSwapModel = TableBuilder(
  ...
  columns: [
    ...
    ColumnBuilder.join(BookLiteModel.table,
        key: "ownerBook", candidateKey: 'id', foreignKey: 'owner_book_id'),
  ],
);

const _tableCompletedSwapLiteModel = TableBuilder(
  tableName: "completed_swaps",
  columns: [
    ColumnBuilder('id'),
    ColumnBuilder('requester_id'),
...
const _tableCompletedSwapDetailModel = TableBuilder(
  tableName: "completed_swaps",
  columns: [
    ColumnBuilder('id'),
    ColumnBuilder('requester_id'),

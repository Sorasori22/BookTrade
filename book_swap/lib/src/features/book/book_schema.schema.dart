...
class BookTable {
  ...
  /// Key: `image_path`
  static const String image = "image_path";
...
@freezed
sealed class BookModel with _$BookModel implements BaseBookSchema, IBookModel {
  const BookModel._();
  ...
  /// - double? averageRating : JsonKey('average_rating')
  /// - ImageObject? image : JsonKey('image_path')
  ...
  const factory BookModel({
    ...
    @JsonKey(name: BookModel.averageRatingKey) required double? averageRating,
  ...
  /// Field name for averageRating field with JsonKey('average_rating')
  static const String averageRatingKey = "average_rating";

  /// Field name for image field with JsonKey('image_path')
  static const String imageKey = "image_path";
...
@freezed
sealed class BookLiteModel with _$BookLiteModel implements BaseBookSchema {
...
@freezed
sealed class BookCreateParam with _$BookCreateParam implements BaseBookSchema {
...
@freezed
sealed class BookUpdateParam with _$BookUpdateParam implements BaseBookSchema {

...
import 'package:book_swap/src/presentation/modules/rating/book_rating_widget.dart';
          ...
          builder: (context, ref, child) {
            return CustomScrollView(
              slivers: [
                            ...
                            AppDialog.showConfirmation(
                              ...
                              onConfirm: () async {
                                context.loadingWrapper(() async {
                                  final result =
                                      await ref.read(bookDeleteProvider(bookId).notifier).call();
                ...
                SliverPadding(
                  padding: EdgeInsets.all(AS.sidePadding).copyWith(bottom: 0),
                  sliver: SliverList(
                ...
                SliverPadding(
                  ...
                  sliver: BookRatingWidget(bookId: bookId),
                ),
              ],
            );
          },
